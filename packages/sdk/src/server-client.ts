...
export function createRemoteServerOperations(http: HttpClient): ServerOperations {
  ...
  const clusterPath = (input?: unknown) =>
    `/system/clusters/${encodeURIComponent((input as { clusterId: string }).clusterId)}`;
  const networkPath = (input?: unknown) =>
    `/system/networks/${encodeURIComponent((input as { networkId: string }).networkId)}`;
  const networkBody = (input?: unknown) => {
    const { networkId: _id, ...body } = input as Record<string, unknown>;
    return body;
  };
  const computePath = (input?: unknown) =>
    `/system/compute-clusters/${encodeURIComponent((input as { clusterId: string }).clusterId)}`;
  const clusterBody = (input?: unknown) => {
    const { clusterId: _id, ...body } = input as Record<string, unknown>;
    return body;
  };
  const tunnelPath = (id: string, input: unknown) =>
    path(id) + `/tunnels/${encodeURIComponent((input as { tunnelId: string }).tunnelId)}`;
  return Object.freeze({
    ...createRemoteScopedOperations(http, ServerCollectionSchemas, {
      ...
      verifyNetwork: {
        method: "POST",
        path: (input) => networkPath(input) + "/verify",
        body: networkBody,
      },
      ...
      getClusterRuntime: {
        method: "GET",
        path: (input) => computePath(input) + "/runtime",
        inputLocation: "path",
      },
      getClusterStorage: {
        method: "GET",
        path: (input) =>
          computePath(input) +
          "/storage" +
          ((input as { observe?: boolean }).observe ? "?observe=true" : ""),
        inputLocation: "path",
      },
      setupClusterStorage: {
        method: "POST",
        path: (input) => computePath(input) + "/storage",
        body: clusterBody,
      },
      retryClusterStorage: {
        method: "POST",
        path: (input) => computePath(input) + "/storage/retry",
        body: clusterBody,
      },
      configureClusterStorageBackup: {
        method: "PATCH",
        path: (input) => computePath(input) + "/storage/backup",
        body: clusterBody,
      },
      ...
      retryClusterRuntime: {
        method: "POST",
        path: (input) => computePath(input) + "/runtime/retry",
        body: clusterBody,
      },
      ...
      reviseManagedNetworkAccess: {
        method: "PATCH",
        path: (input) =>
          `/system/networks/preparations/${encodeURIComponent((input as { preparationId: string }).preparationId)}/connections`,
        body: (input) => {
          const { preparationId: _id, ...body } = input as Record<string, unknown>;
          return body;
        },
      },
      listManagedNetworkPreparations: {
        method: "GET",
        path: () => "/system/networks/preparations",
      },
      getManagedNetworkPreparation: {
        method: "GET",
        path: (input) =>
          `/system/networks/preparations/${encodeURIComponent((input as { preparationId: string }).preparationId)}`,
        inputLocation: "path",
      },
      ...
      removeManagedNetworkOperationMember: {
        ...
        body: (input) => {
          const { operationId: _id, serverId: _server, ...body } = input as Record<string, unknown>;
          return body;
        },
      },
      ...
      verifyCluster: {
        method: "POST",
        path: (input) => clusterPath(input) + "/verify",
        body: clusterBody,
      },
    ...
    ...createRemoteResourceOperations(http, ServerResourceSchemas, {
      ...
      githubStatus: {
        method: "GET",
        path: (id) => `/system/servers/${encodeURIComponent(id)}/github`,
      },
      connectGitHub: {
        method: "POST",
        path: (id) => `/system/servers/${encodeURIComponent(id)}/github/connect`,
      },
      pollGitHubConnection: {
        method: "GET",
        path: (id) => `/system/servers/${encodeURIComponent(id)}/github/connect/poll`,
        envelope: "data",
      },
      setGitHubToken: {
        method: "PUT",
        path: (id) => `/system/servers/${encodeURIComponent(id)}/github/token`,
      },
      generateGitHubKey: {
        method: "POST",
        path: (id) => `/system/servers/${encodeURIComponent(id)}/github/ssh-key`,
      },
      useGitHubDeployKeys: {
        method: "PUT",
        path: (id) => `/system/servers/${encodeURIComponent(id)}/github/deploy-key-mode`,
      },
      disconnectGitHub: {
        method: "DELETE",
        path: (id) => `/system/servers/${encodeURIComponent(id)}/github`,
      ...
      startTunnel: {
        method: "POST",
        inputLocation: "path",
        path: (id, input) => tunnelPath(id, input) + "/start",
      },
      stopTunnel: {
        method: "POST",
        inputLocation: "path",
        path: (id, input) => tunnelPath(id, input) + "/stop",
      },
      ...
      containerApplySession: {
        ...
        path: (id, input) =>
          path(id) +
          `/containers/${encodeURIComponent((input as { component: string }).component)}/apply/session`,
      },
      get: { method: "GET", path },
      ...
      applyModule: {
        ...
        inputLocation: "path",
        path: (id, input) =>
          path(id) + `/modules/${encodeURIComponent((input as { module: string }).module)}/apply`,
      },
      ...
      check: {
        method: "POST",
        path: () => "/system/check",
        body: (serverId, input) => ({ ...(input as object), serverId }),
      },
      installComponent: {
        method: "POST",
        path: () => "/system/install",
    ...
    ...createRemoteScopedOperations(http, ServerInstallSessionSchemas, {
      getInstallSession: {
        ...
        path: (input) => {
          ...
          return (
            "/system/install/session" + (sessionId ? `?id=${encodeURIComponent(sessionId)}` : "")
          );
        },
      },
    ...
    async *applyContainer(value, command, options = {}) {
      ...
      yield* http.events(
        path(id) + `/containers/${input.component}/apply/stream?intent=${input.intent ?? "update"}`,
        { method: "POST", signal: options.signal },
      );
    },
    async *managedNetworkPreparationEvents(value, options = {}) {
      const id = parseInput(ResourceIdSchema, value);
      yield* http.events(`/system/networks/preparations/${encodeURIComponent(id)}/stream`, {
        signal: options.signal,
      });
    },
    async *managedNetworkOperationEvents(value, options = {}) {
      const id = parseInput(ResourceIdSchema, value);
      yield* http.events(`/system/networks/operations/${encodeURIComponent(id)}/stream`, {
        signal: options.signal,
      });
    },
    ...
    async *clusterStorageEvents(value, options = {}) {
      const id = parseInput(ResourceIdSchema, value);
      yield* http.events(`/system/compute-clusters/${encodeURIComponent(id)}/storage/stream`, {
        signal: options.signal,
      });
    },
    async *clusterRuntimeEvents(value, options = {}) {
      const id = parseInput(ResourceIdSchema, value);
      yield* http.events(`/system/compute-clusters/${encodeURIComponent(id)}/runtime/stream`, {
        signal: options.signal,
      });
    },
    async *containerApplyEvents(value, command, options = {}) {
      ...
      yield* http.events(path(id) + `/containers/${input.component}/apply/stream`, {
        signal: options.signal,
      });
    },
    async *installComponents(value, command, options = {}) {
      ...
      yield* http.events("/system/install/stream", {
        method: "POST",
    ...
    async *installEvents(command = {}, options = {}) {
      ...
      yield* http.events(
        "/system/install/stream" +
          (input.sessionId ? `?id=${encodeURIComponent(input.sessionId)}` : ""),
        { signal: options.signal },
      );
    },
    async *monitor(value, options = {}) {
      const id = parseInput(ResourceIdSchema, value);
      yield* http.events(`/system/monitor/stream?serverId=${encodeURIComponent(id)}`, {
        signal: options.signal,
      });
    },
